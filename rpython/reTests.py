...
tests = [
    # Test ?P< and ?P= extensions -- NOT CURRENTLY SUPPORTED
...
#    ('(?P<foo!>a)', '', SYNTAX_ERROR),      # Begins with an illegal char
    ...
    # Same tests, for the ?P= form -- NOT CURRENTLY SUPPORTED
...
#    ('(?P<foo_123>a)(?P=foo_123)', 'aa', SUCCEED, 'g1', 'a'),
    ...
    # Test octal escapes -- NOT CURRENTLY SUPPORTED
...
#    ('(a)(b)(c)(d)(e)(f)(g)(h)(i)(j)(k)(l)\\119', 'abcdefghijklk9', SUCCEED, 'found+"-"+g11', 'abcdefghijklk9-k'),
    ...
    # Test \0 is handled everywhere -- NOT CURRENTLY SUPPORTED
...
#    ('$', 'abc', SUCCEED, 'found+"-"', '-'),
    ...
    ('(abc', '-', SYNTAX_ERROR),
    ('a]', 'a]', SUCCEED, 'found', 'a]'),
    # TODO: This next test should pass really...
    ...
    ('a[^-b]c', 'a-c', FAIL),
    ('a[^]b]c', 'a]c', FAIL),
    # TODO: Should pass as above
    #('a[^]b]c', 'adc', SUCCEED, 'found', 'adc'),
    # Does not yet support anchors
#    ('\\ba\\b', 'a-', SUCCEED, '"-"', '-'),
#    ('\\ba\\b', '-a', SUCCEED, '"-"', '-'),
#    ('\\ba\\b', '-a-', SUCCEED, '"-"', '-'),
#    ('\\by\\b', 'xy', FAIL),
...
#    ('([abc]*)\\1', 'abcabc', SUCCEED, 'found+"-"+g1', 'abcabc-abc'),
    ...
    ('([^N]*N)+', 'N', SUCCEED, 'found+"-"+g1', 'abNNxyzN-xyzN'),
    ...
    # Test symbolic groups - not supported currently
...
#    ('(?P<id>aa)(?P=xd)', 'aaaa', SYNTAX_ERROR),
    ...
    # Test octal escapes/memory references - not supported currently
...
#    ('$', 'abc', SUCCEED, 'found', ''),
    ...
    ('a[', '-', SYNTAX_ERROR),
    ('a]', 'a]', SUCCEED, 'found', 'a]'),
    # TODO: Should be able to pass this test
#    ('a[]]b', 'a]b', SUCCEED, 'found', 'a]b'),
    ('a[^bc]d', 'aed', SUCCEED, 'found', 'aed'),
    ('a[^bc]d', 'abd', FAIL),
    ('a[^-b]c', 'adc', SUCCEED, 'found', 'adc'),
...
#    ('(?i)((((((((((a))))))))))\\10', 'AA', SUCCEED, 'found', 'AA'),
    ...
    ('(?i)(((((((((a)))))))))', 'A', SUCCEED, 'found', 'A'),
    # Capturing groups not currently supported
#    ('(?i)(?:(?:(?:(?:(?:(?:(?:(?:(?:(a))))))))))', 'A', SUCCEED, 'g1', 'A'),
...
#    ('(?i)([a-c]*)\\1', 'ABCABC', SUCCEED, 'g1', 'ABC'),
     # Lookahead not currently supported
...
#    ('(?s)a.b', 'a\nb', SUCCEED, 'found', 'a\nb'),
    ...
    # TODO: Should be able to pass the following test
#    ('[\\D]+', '1234abc5678', SUCCEED, 'found', 'abc'),
